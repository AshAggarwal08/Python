...
def browserInstance(request):
    ...
    if browser_name == "chrome":  #firefox
        ...
        print(f"Warning: Browser '{browser_name}' not supported. Defaulting to Chrome.")
        driver = webdriver.Chrome()
    else:
        print("Warning: No browser name provided. Defaulting to Chrome.")
        driver = webdriver.Chrome()
    ...
    if driver is not None:
        ...
        pytest.fail("Failed to initialize WebDriver.")
